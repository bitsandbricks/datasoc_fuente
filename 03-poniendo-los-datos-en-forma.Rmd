...
Se trata de la lógica de conjuntos, o lógica _booleana_, que con un poco de suerte recordamos de nuestra época de escolares. Los símbolos importantes son `&`, `|`, y `!`: "y", "ó", y la negación que invierte preposiciones:
